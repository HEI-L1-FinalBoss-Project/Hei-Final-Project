...
public class EventParticipantIT {
  ...
  void manager_write_create_ok() throws ApiException {
    ...
    EventParticipant expected2 = createdParticipants();
    expected2.setId(created.get(0).getId());

    assertEquals(List.of(participant1, created.get(0)), List.of(expected1, expected2));
  }
