...
class EventIT {
  ...
  public static Event event1() {
    return new Event()
        ...
        .type("course")
        .place("place1_id")
        .startDatetime(Instant.parse("2022-12-20T10:25:24.00Z"))
        .endDatetime(Instant.parse("2022-12-20T11:25:29.00Z"))
  ...
  public static List<Event> someCreatableEvents() {
    return List.of(
        new Event()
            .place("place2_id")
            .type("course")
            .endDatetime(Instant.parse("2022-08-08T10:22:22.00Z"))
            .startDatetime(Instant.parse("2022-08-08T10:52:22.00Z"))
            .responsible("teacher1_id")
    );
  }
