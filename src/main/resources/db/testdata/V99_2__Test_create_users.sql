insert into "user"
(id, group_id, first_name, last_name, email, ref, status, sex, birth_date, entrance_datetime, phone, address,
 "role")
values ('student1_id', 'group1_id', 'Ryan', 'Andria', 'test+ryan@hei.school', 'STD21001', 'ENABLED', 'M',
        '2000-01-01',
        '2021-11-08T08:25:24.00Z', '0322411123', 'Adr 1', 'STUDENT'),
       ('student2_id', 'group2_id', 'Two', 'Student', 'test+student2@hei.school', 'STD21002', 'ENABLED', 'F',
        '2000-01-02',
        '2021-11-09T08:26:24.00Z', '0322411124', 'Adr 2', 'STUDENT'),
       ('student3_id', 'group1_id', 'Three', 'Student', 'test+student3@hei.school', 'STD21003', 'ENABLED', 'F',
        '2000-01-02',
        '2021-11-09T08:26:24.00Z', '0322411124', 'Adr 2', 'STUDENT');
insert into "user"
